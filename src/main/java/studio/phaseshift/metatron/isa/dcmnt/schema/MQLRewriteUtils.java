...
/**
 * dcmntSpace-specific rewrite utilities.
 * <p>
 * Currently uses the same string format as SQL backends because
 * {@code parseMongoFilter} re-parses the formatted string.
 * When that is refactored to accept structured conditions, swap
 * the formatter for a native MongoDB implementation.
 *
 * @author Marko A. Rodriguez (http://markorodriguez.com)
 */
public final class MQLRewriteUtils {

    private MQLRewriteUtils() {}

    /** String-based condition formatting (re-parsed by parseMongoFilter for now). */
    ...
    /** Conjunction via AND for MongoDB $and semantics. */
