...
==>[
    ...
    size=>mB::483.0000,
    tag=>24,
    container=>[!*docker:container/webprobe-630547]]
==>[
    containers=>0,
...
==>[ command=></docker-entrypoint.sh nginx -g 'daemon off;>,
    created_at=>datetime::<//2026.09:6/08/04/23/000?tz=-0600>,
    id=><1eb7c44d5ad93738d6c2cabacec394ae72d57500638fe8c7d2b7783bdea40a03>,
...
==>[ command=>"/bin/sh -c 'apt-get update     && apt-get install -y --no-i...",
    ...
    ...(2 more)]
==>[ command=></docker-entrypoint.sh nginx -g 'daemon off;>,
    created_at=>datetime::<//2026.09:5/15/45/05/000?tz=-0600>,
    id=>e2e15f24f58173e7c928c64641c940cddc611e9969e3fe5e5f22552e44efa9be,
...
==>[
    driver=>local,
    labels=>[=>],
    mountpoint=>/var/lib/docker/volumes/c96354bf63cfa425fae60f2eac4b6841cf2081eac71f3655bbd0fd73a58574bf/_data,
    name=>c96354bf63cfa425fae60f2eac4b6841cf2081eac71f3655bbd0fd73a58574bf,
    scope=>local]
==>[
    driver=>local,
    labels=>[=>],
...
==>[
    driver=>local,
    labels=>[=>],
    mountpoint=>/var/lib/docker/volumes/9aa01f536e14f18178ac47626be8cbfa7750be9f22a8b19381158c3351801501/_data,
    name=><9aa01f536e14f18178ac47626be8cbfa7750be9f22a8b19381158c3351801501>,
    scope=>local]
==>[
    driver=>local,
    labels=>[=>],
...
==>[
    driver=>local,
    mountpoint=>/var/lib/docker/volumes/hindsight-data/_data,
    name=>hindsight-data,
    scope=>local,
    container=>[docker:container/hindsight]]
==>[
    driver=>local,
    labels=>[=>],
...
==>[
    driver=>local,
    labels=>[=>],
    mountpoint=>/var/lib/docker/volumes/5c3a3f49281092d8d8e22a3746a8d6f353fd152383f2cf31146e87608d8ebf18/_data,
    name=><5c3a3f49281092d8d8e22a3746a8d6f353fd152383f2cf31146e87608d8ebf18>,
    scope=>local]
==>[
    driver=>local,
    labels=>[
...
==>[
    driver=>local,
    labels=>[=>],
    mountpoint=>/var/lib/docker/volumes/47fd83106964ad167398f733f9b870d476e5bf36ca982d1e8e0feaa94a6bb33b/_data,
    name=><47fd83106964ad167398f733f9b870d476e5bf36ca982d1e8e0feaa94a6bb33b>,
    scope=>local]
==>[
    driver=>local,
    labels=>[=>],
...
==>[
    driver=>local,
    labels=>[=>],
    mountpoint=>/var/lib/docker/volumes/7b1c40b0acdf48f985f73c92d3996f842e959201a4f17ed1d8cd707c8451c4a2/_data,
    name=><7b1c40b0acdf48f985f73c92d3996f842e959201a4f17ed1d8cd707c8451c4a2>,
    scope=>local]
==>[
    driver=>local,
    labels=>[=>],
...
==>[
    driver=>local,
    labels=>[=>],
    mountpoint=>/var/lib/docker/volumes/28b57f3d22d083cc0c7378310c7df25f48d24cc30bebbfe8078c894bd931f19f/_data,
    name=><28b57f3d22d083cc0c7378310c7df25f48d24cc30bebbfe8078c894bd931f19f>,
    scope=>local]
==>[
    driver=>local,
...
==>[
    driver=>local,
    labels=>[=>],
    mountpoint=>/var/lib/docker/volumes/0cc30068546c1ec65d9352d8b49547d0aa93592c370216df1b107202f53e2b34/_data,
    name=><0cc30068546c1ec65d9352d8b49547d0aa93592c370216df1b107202f53e2b34>,
    scope=>local]
...
==>[
    created_at=>datetime::<//2026.09:1/00/51/11/662?tz=+0000>,
    driver=>bridge,
    id=><3c9477c10803>,
    ipv4=>true,
    ipv6=>false,
...
==>[
    ...
    scope=>local]
==>[
    created_at=>datetime::<//2026.09:1/00/51/27/359?tz=+0000>,
    driver=>bridge,
    id=><00dff33df8f8>,
    ipv4=>true,
    ipv6=>false,
...
==>[
    ...
    scope=>local]
==>[
    created_at=>datetime::<//2026.09:5/15/45/05/385?tz=+0000>,
    driver=>bridge,
    id=>d1db6957bf3f,
    ipv4=>true,
    ipv6=>false,
...
==>[
    created_at=>datetime::<//2026.09:1/04/11/15/401?tz=+0000>,
    driver=>bridge,
    id=>ba9ff0eee389,
    ipv4=>true,
    ipv6=>false,
    ...
    labels=>[
     <com.docker.compose.network>=>default,
     <com.docker.compose.project>=>l1,
     <com.docker.compose.version>=><2.40.3>,
     <com.docker.compose.config-hash>=>aac22bc02f6aa91db64bd145247dcdea3d4a40f7e86d39165a1f1b78170f1810],
    name=>l1_default,
    scope=>local]
==>[
    created_at=>datetime::<//2026.09:1/00/50/44/453?tz=+0000>,
    driver=>bridge,
    id=><256d211beb6f>,
    ipv4=>true,
    ipv6=>false,
...
==>fail::[apply failure:
   	...
   	[inst]   │ ref?rng=#{*}&dom=#([driver=>local]){<j>}@<1>
   	 \_dom   │ #::T
   	 \_args  │ [[driver=>local]][ProcessBuilder<1065>:fail[ProcessBuilder<1065>:(NullPointerException)] ← (NullPointerException)]][fail[ProcessBuilder<1065>:(NullPointerException)]][]@/sys/fail/292
```
### Remove a volume
...
==>[
    created_at=>datetime::<//2026.09:6/08/04/50/165?tz=+0000>,
    driver=>bridge,
    id=>f4a0ed439312,
    ipv4=>true,
    ipv6=>false,
...
==>[ command=>"""/sbin/tini -g -- sh -c 'sqlite3 /data/mydb.sqlite \".databa...""",
    created_at=>datetime::<//2026.09:6/08/04/56/000?tz=-0600>,
    id=>cbde52d2f0cfdf64285355b1a57b21efbfbc9b50dad6d4c9d53c2699bed5d316,
    image=>!*docker:image/keinos/sqlite3:latest,
    local_volumes=>0,
...
==>fail::[apply failure:
   	...
   	[inst]   │ /m/inst/explain_compute?rng=str&dom=noobj{0}(/m/tble/inst/rewrite/sql_count?int<=#{0}(people/+)){<j>}@<0>
   	 \_dom   │ noobj
   	 \_args  │ [/m/tble/inst/rewrite/sql_count?int<=#{0}(people/+)][MTronException<172>:fail[no stack element<0>:(ClassCastException)] ← (ClassCastException)]][fail[no stack element<0>:(ClassCastException)]][]@/sys/fail/294
```
