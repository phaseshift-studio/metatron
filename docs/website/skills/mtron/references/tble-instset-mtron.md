...
==>/sys/space/tbledoc/instset/award=>rec::T[?[{?}trophy=>str::T,recipient=>isa(person/+/id).!*id()]]@award
==>/sys/space/tbledoc/instset/note=>rec::T[?[{?}body=>str::T]]@note
==>/sys/space/tbledoc/instset/person=>rec::T[?[{?}name=>str::T,{?}age=>int::T,{?}skill=>str::T]]@person
