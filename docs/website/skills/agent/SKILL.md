...
==>[task::[done=>false,desc=>'review metatron docs',start=>datetime::<//2026.08:29/00/19/55/554?tz=-0600>]]@/usr/agent/todo
```
...
==>task::[done=>true,desc=>'review metatron docs',start=>datetime::<//2026.08:29/00/19/55/554?tz=-0600>]
```
