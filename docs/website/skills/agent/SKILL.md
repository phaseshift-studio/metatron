...
==>[task::[done=>false,desc=>'review metatron docs',start=>datetime::<//2026.08:26/03/01/50/649?tz=-0600>]]@/usr/agent/todo
```
...
==>task::[done=>true,desc=>'review metatron docs',start=>datetime::<//2026.08:26/03/01/50/649?tz=-0600>]
```
