...
==>fail::[parse error at line 1, col 7:
     rec::T[done=>bool::T,desc=>str::T,start{?}::T,...
           ^
     could not parse at '[']@/sys/fail/728
mtron> [,]@/usr/agent/todo
==>[,]@/usr/agent/todo
mtron> datetime_now()-<task::[done=>false,desc=>"review metatron docs",start=>_]>-@/usr/agent/todo
==>[task::[done=>false,desc=>'review metatron docs',start=>datetime::<//2026.08:24/13/38/47/405?tz=-0600>]]@/usr/agent/todo
```
...
==>task::[done=>true,desc=>'review metatron docs',start=>datetime::<//2026.08:24/13/38/47/405?tz=-0600>]
```
...
==>fail::[unable to determine inst function:
   	...
   	chat::T     => chat::T   |  \_dom
   	chat::T    ==> ['what is 1+(2+3)?']   |  \_args]@/sys/fail/730
```
